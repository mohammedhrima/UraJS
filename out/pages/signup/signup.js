        ...
        Ura.element("div", { id: "center" },
            Ura.element("div", { id: "card" },
                ...
                Ura.element("div", { id: "input-section" },
                    Ura.element("input", { type: "text", id: "usernmae", placeholder: "Firstname" }),
                    Ura.element("input", { type: "text", id: "usernmae", placeholder: "Lastname" }),
                    Ura.element("br", null),
                    Ura.element("input", { type: "text", id: "usernmae", placeholder: "Username" }),
                    Ura.element("input", { type: "password", id: "password", placeholder: "Password" }),
                    Ura.element("input", { type: "password", id: "password", placeholder: "Confirm Password" })),
