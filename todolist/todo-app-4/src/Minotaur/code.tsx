...
import { Rec, VDOM, Tag, Props, VDOMNode } from "./types.js";
...
function appendChildrenDOM(vdom: VDOM) {
...
function deepEqual(a, b) {
  if (a === b) return true; // Check for strict equality for primitive types
